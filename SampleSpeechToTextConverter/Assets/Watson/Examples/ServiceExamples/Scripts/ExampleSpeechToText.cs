...
{
    private string _username = "e7ae547a-2154-43d6-9e15-338e8a527ebc";
    private string _password = "ZWfWyl5zI2Fy";
    private string _url = "https://stream.watsonplatform.net/speech-to-text/api";

    private AudioClip _audioClip;
    private SpeechToText _speechToText;
    public AudioSource _recording1;
    ...
    void Start()
    {
        ...
        _recording1.clip = Microphone.Start("Built-in Microphone", true, 20, 44100);
    ...
    private void Update() {
        if (Input.GetKeyDown(KeyCode.Space)) {
            Microphone.End(null);
            _audioClip = _recording1.clip;
            //_recording1.clip = _audioClip;
            //_recording1.Play();
